...
int main(int argc, char **argv) {
    ...
    const struct CMUnitTest tests[] = {
        ...
        cmocka_unit_test(test_send_all_sends_data_to_socket),
        cmocka_unit_test(test_send_all_handles_partial_write),
        cmocka_unit_test(test_send_all_fails_on_send_error),
        cmocka_unit_test(test_send_all_fails_on_invalid_input),
        // test_sleep.h
